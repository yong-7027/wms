...
//       await _updateUserReviewHistory(feedback.appointmentId, docRef.id);
//
...
//
//       // Update user's review history
//       await _removeFromUserReviewHistory('', feedbackId);
//
//       // Update service rating statistics
//       await _updateServiceRatingStats(
//         feedback.appointmentId,
...
//         final filePath = '$_mediaStoragePath/$appointmentId/$fileName';
//
